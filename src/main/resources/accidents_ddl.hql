...
Number_of_Vehicles SMALLINT,Number_of_Casualties SMALLINT,Date STRING,Day_of_Week SMALLINT,Time STRING,Local_Authority_District STRING,Local_Authority_Highway STRING,
